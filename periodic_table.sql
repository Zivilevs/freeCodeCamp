...
--
-- Name: elements unique_const; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT unique_const UNIQUE (symbol);


--
-- Name: elements unique_const2; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT unique_const2 UNIQUE (name);


--
-- Name: properties forn_k; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT forn_k FOREIGN KEY (type_id) REFERENCES public.types(type_id);


--
-- Name: properties forn_key; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT forn_key FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
